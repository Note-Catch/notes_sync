...
T = TypeVar("T", bound="BodyAuthApiV1Oauth2AuthPost")


@_attrs_define
class BodyAuthApiV1Oauth2AuthPost:
    """
    Attributes:
        username (str):
        password (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        body_auth_api_v1_oauth_2_auth_post = cls(
            username=username,
            password=password,
        ...
        body_auth_api_v1_oauth_2_auth_post.additional_properties = d
        return body_auth_api_v1_oauth_2_auth_post
